  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView style={styles.container}>
        ...
        <Text
          style={{paddingHorizontal: 30, fontSize: 16, paddingVertical: 15}}>
          Welcome to the Active Standup Test. This test will provide TRACE with
          important data regarding your blood flow dynamics.
        </Text>
        <View style={styles.NavBarDivider} />
        <Text
          style={{paddingHorizontal: 30, paddingVertical: 15, fontSize: 16}}>
          To begin, lay flat on your back. Wait 3 minutes. After 3 minutes pass,
          stand back up.
        </Text>
        <View style={styles.NavBarDivider} />
        <Text
